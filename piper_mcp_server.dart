...
Future<Map<String, dynamic>?> generateRealFeedback({
  ...
  try {
    ...
    final systemPrompt =
        ...
        '- J\'zargo: Competitive performance, aggressive optimization, proving superior coding prowess, speed.\n'
        '- Irileth: Vigilance, threat assessment (bugs/vulnerabilities), protective testing under fire, battle-hardened readiness.\n'
        '- Kodlak: Refactoring technical debt, clean architecture, honor in craftsmanship, inner cleanliness of code.\n'
        '- Ancano: Haughty elitism, supreme refinement of code, Thalmor-style absolute control over complexity.\n'
        '- Nepali: Warm, highly friendly, collaborative, community-focused, humble guide.\n\n'
